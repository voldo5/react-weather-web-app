...
export const Header = (): JSX.Element => {
  ...
  return (
        ...
        <div className="rating">
          ...
          <label htmlFor="happy1">
            <input
              ...
              onFocus={() => {}}                           
            />
            <HerokuIcon className="iconActive1" />
          </label>
    ...
    //     <div className="rating">
    //     {/* "rating-form-1"  ???  */}
    //       <form className={styles.ratingForm1}>
    //       {/* "super-happy1" ??? */}
    //         <label htmlFor={styles.superHappy1}>
    //           <input
    //             type="radio"
    //             name="rating"
    //             className={styles.superHappy1}
    //             id="superHappy1"
    //             value="superHappy1"
    //           />
    //           <svg viewBox="0 0 24 24">
    ...
    //         <label htmlFor={styles.sad1}>
    //           <input
    //             type="radio"
    //             name="rating"
    //             className={styles.sad1}
    //             id="sad1"
    //             value="sad1"
    //           />
    //           <svg viewBox="0 0 24 24">
    ...
    //         </label>
    //         {/* "super-sad1" ??? */}
    //         <label htmlFor={styles.superSad1}>
    //           <input
    //             type="radio"
    //             name="rating"
    //             className={styles.superSad1}
    //             id="super-sad1"
    //             value="super-sad1"
    //           />
    //           <svg viewBox="0 0 24 24">
